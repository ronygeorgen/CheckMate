...
class LoginView(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            response.set_cookie('access_token', tokens['access'], httponly=True, secure=True, samesite='True')
            response.set_cookie('refresh_token', tokens['refresh'], httponly=True, secure=True, samesite='True')
            return response
